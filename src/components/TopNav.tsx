...
import {
  ...
  Settings, LogOut, User, ChevronDown, Menu, X, Brain, Users, ShieldAlert, Bot, Wrench, ClipboardCheck, Activity, Bug
} from "lucide-react";
...
const navItems = [
  ...
  { label: "Status Agentes", path: "/agents/status", icon: Activity },
